...
func Fieldset(attributes Attr, html ...string) string {
	return d("fieldset", attributes, html)
}

// <figcaption> 标签定义 figure 元素的标题（caption）。
// figcaption 元素应该被置于 figure 元素的第一个或最后一个子元素的位置。
func Figcaption(attributes Attr, html ...string) string {
	return d("figcaption", attributes, html)
}

// <figure> 标签规定独立的流内容（图像、图表、照片、代码等等）。
// figure 元素的内容应该与主内容相关，但如果被删除，则不应对文档流产生影响。
func Figure(attributes Attr, html ...string) string {
	return d("figure", attributes, html)
}

// <footer> 标签定义 section 或 document 的页脚。
// 典型地，它会包含创作者的姓名、文档的创作日期以及/或者联系信息。
func Footer(attributes Attr, html ...string) string {
	return d("footer", attributes, html)
}

// <form> 标签创建供用户输入的表单。
// 表单可包含文本域，复选框，单选按钮等等。表单用于向指定的 URL 传递用户数据。
func Form(attributes Attr, html ...string) string {
	return d("form", attributes, html)
}

// <h1> - <h6> 标签可定义标题。<h1> 定义最大的标题。<h6> 定义最小的标题
func H1(attributes Attr, html ...string) string {
	return d("h1", attributes, html)
}

// <h1> - <h6> 标签可定义标题。<h1> 定义最大的标题。<h6> 定义最小的标题
func H2(attributes Attr, html ...string) string {
	return d("h2", attributes, html)
}

// <h1> - <h6> 标签可定义标题。<h1> 定义最大的标题。<h6> 定义最小的标题
func H3(attributes Attr, html ...string) string {
	return d("h3", attributes, html)
}

// <h1> - <h6> 标签可定义标题。<h1> 定义最大的标题。<h6> 定义最小的标题
func H4(attributes Attr, html ...string) string {
	return d("h4", attributes, html)
}

// <h1> - <h6> 标签可定义标题。<h1> 定义最大的标题。<h6> 定义最小的标题
func H5(attributes Attr, html ...string) string {
	return d("h5", attributes, html)
}

// <h1> - <h6> 标签可定义标题。<h1> 定义最大的标题。<h6> 定义最小的标题
func H6(attributes Attr, html ...string) string {
...
func Header(attributes Attr, html ...string) string {
...
func I(attributes Attr, html ...string) string {
	return d("i", attributes, html)
}

// <iframe> 标签创建包含另一个文档的行内框架。
func Iframe(attributes Attr, html ...string) string {
	return d("iframe", attributes, html)
}

// <img> 标签定义图像。
func Img(attributes Attr) string {
	var s bytes.Buffer
	s.WriteString("<img")
	for k, v := range attributes {
		s.WriteString(" " + k + "=\"" + v + "\"")
...
func Input(attributes Attr, html ...string) string {
	return d("input", attributes, html)
}

// <ins> 标签定义文档的插入的新文本
func Ins(attributes Attr, html ...string) string {
